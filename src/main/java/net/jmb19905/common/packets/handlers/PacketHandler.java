...
public abstract class PacketHandler<P extends Packet> {
    ...
    public abstract <T extends Packet> void handleOnServer(P packet, ServerHandler serverHandler, ServerHandler.ClientConnection connection, Channel channel);

    public abstract <T extends Packet> void handleOnClient(P packet, EncryptedConnection encryption, Channel channel);
